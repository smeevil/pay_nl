defmodule PayNL.Options do
  ...
  @required_fields [:amount_in_cents, :api_token, :currency, :notification_url, :remote_ip, :return_url, :service_id]
  @optional_fields [
    :custom_data,
    :description,
    :payment_option_id,
  ...
  @doc """
  Use this to create the PayNL.Options struct which will validate all options given.
  """
  @spec create(params :: map | list) :: {:ok, %PayNL.Options{}} | {:error, Ecto.Changeset.t}
  def create(params \\ %{})
  def create(params) when is_list(params), do: create(Enum.into(params, %{}))
  def create(params) do
    case payment_changeset(%PayNL.Options{}, params) do
  ...
  """
  @spec credentials(params :: map | list) :: {:ok, %PayNL.Options{}} | {:error, Ecto.Changeset.t}
  ...
  defp credentials_changeset(params) do
    ...
    %PayNL.Options{}
    |> cast(params, [:api_token, :service_id])
    |> validate_required(
         :api_token,
  ...
  @spec payment_changeset(struct :: %PayNL.Options{}, params :: map) :: Ecto.Changeset.t
  ...
  @spec to_post_map(options :: %PayNL.Options{}) :: map
  def to_post_map(%PayNL.Options{} = options) do
    options
    |> Map.from_struct
    |> Map.delete(:__meta__)
