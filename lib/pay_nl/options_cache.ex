defmodule PayNL.TransactionOptionsCache do
  @moduledoc """
  ...
  def handle_call({:payment_options}, _from, state) do
    if state.hot_cache do
      ...
      case get_payment_options() do
        {:ok, data} -> {:reply, {:ok, data}, %{hot_cache: true, cache: data}}
  ...
  defp get_payment_options, do: PayNL.TransactionOptions.credentials() |> PayNL.Client.get_payment_options
end
